...
class Addmovie extends Component {
    ...
    handleSubmit = () => {
        ...
        if (this.props.nameToBeEdited.length <= 0) {
            ...
            console.log(obj)
            this.props.movieUpdate(this.props.nameToBeEdited, obj)
            ToastsStore.success("Movie edited successfully")
        }

    }
    delete() {
        this.props.movieDelete(this.props.nameToBeDeleted)
                        ...
                        <MDBCol md="12">
                            <MDBCard>
                                <MDBCardBody>
                                    ...
                                    <MDBInput type="text" id='ename' className="form-control" label="Enter Movie name to be edited" onChange={this.props.onMovieEditNameChange} value={this.props.nameToBeEdited} title="Must be Alphabet" required />
                                    ...
                                    <MDBInput type="text" id='ename' className="form-control" label="Enter Movie name to be deleted" onChange={this.props.onMovieDeleteNameChange} value={this.props.nameToBeDeleted} title="Must be Alphabet" required />
