...
class AddActor extends Component {
    ...
    handleSubmitUpdate = () => {
        ...
        else if (this.props.nameToBeUpdated.length <= 0 && this.props.ageToBeUpdated <= 0) {
                                            ...
                                            <tr>
                                                <td colSpan="2">
                                                    <div className="form-group">
                                                        ...
                                                        <MDBInput type="text" id='delete' className="form-control form-control-lg" label="Actress name to delete" onChange={this.props.onNameDelete} value={this.props.nameToBeDeleted} title="Must be Alphabet" required />
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="form-group">
                                                        ...
                                                        <MDBInput type="text" id='edit' className="form-control form-control-lg" label="Old Actress name" onChange={this.props.onNameEdit} value={this.props.nameToBeEdited} title="Must be Alphabet" required />
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="form-group">

                                                        <MDBInput type="text" id='update' className="form-control form-control-lg" label="New Actress name " onChange={this.props.onNameUpdate} value={this.props.nameToBeUpdated} title="Must be Alphabet" required />
                                                    </div>
                                                </td>
                                                <td>
